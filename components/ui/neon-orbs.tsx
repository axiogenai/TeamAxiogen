...
export function NeonOrbs() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center bg-slate-100 dark:bg-[#050a18] transition-colors duration-500">
      ...
      {/* Center text */}
      <div className="relative z-10 flex flex-col items-center gap-6 text-center text-indigo-900 dark:text-white transition-colors duration-500">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          className={`logo-img w-36 md:w-44 h-auto transition-all duration-1000 ease-out ${
            mounted 
              ? "opacity-100 scale-100 translate-y-0" 
              : "opacity-0 scale-95 translate-y-4"
          }`}
          style={{ transitionDelay: "200ms", filter: "drop-shadow(0 0 30px rgba(255,255,255,0.15))" }}
          src="/logo.png"
          alt="AXIOGEN Logo"
        />
        <div>
